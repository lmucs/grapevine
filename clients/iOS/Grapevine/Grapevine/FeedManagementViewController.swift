...
class FeedManagementViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.refreshControl.addTarget(self, action: #selector(refresher), forControlEvents: UIControlEvents.ValueChanged)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            cell.button.addTarget(self, action: #selector(addFeed), forControlEvents: UIControlEvents.TouchUpInside)
            cell.segControl.addTarget(self, action: #selector(selectNetwork), forControlEvents: UIControlEvents.ValueChanged)
